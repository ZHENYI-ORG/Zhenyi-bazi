...
它源自**传统盲派师承**，经过十余年线下命理实务沉淀，尝试将真实命理工作中的排盘、校时、取象与结构判断，整理为一套可运行、可追踪、可验证的 TypeScript 开源系统。
...
传统命理解决“如何看盘”，现代工程解决“如何稳定地把它做出来”。真一希望在不牺牲传统方法核心逻辑的前提下，把长期实践中的基础能力做成清晰、可靠、可复用的开源工具。

## 为什么是它

传统排盘回答“盘里有什么”。真一进一步尝试回答：**这张命盘是如何运转的。**

从“看到十神”，走向“理解作用”；从“描述命局”，走向“解释结果”；从“判断倾向”，走向“追踪触发时点”。这正是本项目区别于普通排盘工具的核心方向。
