...
> **来自盲派郝金阳大师一脉传承 · 十余年线下算命师实务 · 开源八字排盘系统**
...
真一八字排盘，是来自盲派郝金阳大师一脉传承的实践工具，凝结十余年线下算命师实践，先把出生时间、出生地点和四柱排准确，再进一步整理命局中的关键关系，帮助你看清一张命盘是怎样运转的。

很多排盘软件只能把四柱、十神和神煞列出来。
...
它适合算命从业者、传统文化研究者，以及想认真了解自己命盘的人。

项目使用 TypeScript 开发并开源，支持在线体验，也支持下载源码后在本地运行和继续开发。

[立即体验真一八字排盘](https://www.zhenyi.org/) · [查看源码](https://github.com/ZHENYI-ORG/zhenyi-bazi-paipan)
...
看命不能只看命局里有没有财、官、印、食，更要看这张命盘到底在做什么功。

所谓做功，是命局围绕某个目标，通过具体的生克制化关系，去取得、制约、转化或输出某种力量，并最终形成相应结果。

判定时重点看四件事：

- 命局要做的是什么功；
- 由哪些字来完成这件功；
- 通过什么方式完成：生、克、制、化、合、冲、刑、穿、墓等；
- 这份功最后落在什么位置，形成什么结果。

例如食伤生财、财制印、伤官制官、印化官杀，都不是可以直接套用的固定结论。还要结合干支位置、宾主体用、力量来源、作用是否成立，以及是否被岁运引动来判断。

因此，做功结构关注的不是“盘里有什么”，而是：

> 这张命盘究竟想做什么、靠什么去做、做成了什么。

系统会将命局中的做功方向、参与干支、作用方式、结果落点及岁运触发条件进行整理，帮助使用者看清一张命盘的实际运转方式。
...
- **AI 算命解读 Prompt**：结合长期实务经验、师门方法与真一内部算命解读体系调校的提示词与工作流
- **专业算命解读体系**：师门理法、做功取象、直断方法、案例经验及内部规则体系
...
项目背后是长期的线下算命工作与传统师承经历。我们真正关心的，从来不只是软件能不能排出八个字，而是**传统方法如何在今天仍然能够被准确地使用，专业经验如何通过现代技术转化成更稳定、更易用的工具。**
...
开发者可以阅读实现，算命从业者可以核对规则，不同体系之间也可以基于清楚的代码讨论差异，而不是永远依赖无法解释的黑箱结果。
...
不同算命流派存在不同理论口径与使用方法。项目内容不构成医疗、法律、金融、投资等专业意见，也不应作为重大现实决策的唯一依据。
