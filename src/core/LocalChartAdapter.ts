...
const SHI_SHEN_FULL:Record<string,string>={比:'比肩',劫:'劫财',食:'食神',伤:'伤官',财:'偏财',才:'正财',杀:'七杀',官:'正官',枭:'偏印',印:'正印'};
const STEM_ELEMENT:Record<string,string>={甲:'木',乙:'木',丙:'火',丁:'火',戊:'土',己:'土',庚:'金',辛:'金',壬:'水',癸:'水'};
const STEM_YIN_YANG:Record<string,string>={甲:'阳',乙:'阴',丙:'阳',丁:'阴',戊:'阳',己:'阴',庚:'阳',辛:'阴',壬:'阳',癸:'阴'};
const HIDDEN_STEMS:Record<string,string[]>={子:['癸'],丑:['己','癸','辛'],寅:['甲','丙','戊'],卯:['乙'],辰:['戊','乙','癸'],巳:['丙','戊','庚'],午:['丁','己'],未:['己','丁','乙'],申:['庚','戊','壬'],酉:['辛'],戌:['戊','辛','丁'],亥:['壬','甲']};
...
export class LocalChartAdapter {
  ...
  private parseQiyun(desc:string):any{const val=(re:RegExp)=>Number(re.exec(desc)?.[1]??0);return {year:val(/(\d+)年/),month:val(/(\d+)月/),day:val(/(\d+)天/),hour:val(/(\d+)时/)}};
